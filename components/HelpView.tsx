      ...
      <div className="bg-white p-6 rounded-lg shadow border-l-4 border-indigo-500">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          ...
          <div className="bg-amber-50 p-4 rounded-lg border border-amber-200">
            <h4 className="font-bold text-amber-800 mb-2">匯入舊版 (v1) 資料</h4>
            <p className="text-sm text-amber-700 mb-4">如果您之前使用「單人版」且沒有使用者名稱，請點此將資料匯入到目前帳戶。</p>
            <button 
              onClick={onMigrateLegacy}
              className="bg-amber-100 hover:bg-amber-200 text-amber-900 border border-amber-300 px-4 py-2 rounded shadow-sm flex items-center gap-2 transition w-full justify-center"
            >
              <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
